...
const styles = StyleSheet.create({
  ...
  rankText: { color: '#fff', fontSize: 20, fontWeight: '700' }, // POVEČANO
  leaderboardName: { color: '#fff', fontSize: 18, fontWeight: '600', flex: 1 },
  medalBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#222', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
  medalText: { color: '#fff', fontWeight: '800', marginLeft: 4, fontSize: 15 }, // POVEČANO
