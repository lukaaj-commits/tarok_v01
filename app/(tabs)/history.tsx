...
import { ChevronRight, Trophy, Trash2, CheckCircle, Info, TrendingUp, Calendar, Clock } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.mainHeader}>
          ...
          <TouchableOpacity onPress={loadGlobalStats}>
              <LinearGradient 
                colors={GRADIENT_COLORS} 
                start={{x: 0, y: 0}} 
                end={{x: 1, y: 0}}
                style={styles.globalStatsButton}
              >
                            ...
                            return (
                                <TouchableOpacity key={stat.name} style={styles.leaderboardItem} onPress={() => openGlobalPlayerDetails(stat)}>
                                    ...
                                    <View style={{flex: 1, paddingLeft: 8, justifyContent: 'center'}}>
                                        ...
                                        <Text style={{color: COLORS.textMuted, fontSize: 12}}>{stat.total_games} iger</Text>
                                    </View>
                                    <View style={{flexDirection: 'row', gap: 8, alignItems: 'center'}}>
                                        <View style={styles.medalBox}><Trophy size={16} color="#ffd700" /><Text style={styles.medalText}>{stat.wins}</Text></View>
                                        <View style={styles.medalBox}><Trophy size={16} color="#c0c0c0" /><Text style={styles.medalText}>{stat.second}</Text></View>
                                        <View style={styles.medalBox}><Trophy size={16} color="#cd7f32" /><Text style={styles.medalText}>{stat.third}</Text></View>
                        ...
                        <ScrollView style={styles.detailScroll}>
                            ...
                            <View style={styles.lastGamesSection}>
                                <View style={{flexDirection:'row', alignItems:'center', marginBottom:10}}>
                                    ...
                                    <Text style={[styles.sectionTitle, { marginBottom: 0 }]}>Zadnjih 5 iger</Text>
                                </View>
                    ...
                    {playerRadelci.length > 0 && (
                        <View style={styles.radelciContainer}>
                            {playerRadelci.map((radelc) => (
                                <View key={radelc.id} style={[styles.radelc, radelc.is_used ? styles.radelcUsed : styles.radelcUnused]} />
                            ))}
                        </View>
                    )}
                  ...
                  return (
                    <View key={player.id} style={styles.playerHistorySection}>
                      ...
                      <View style={[styles.playerHistoryHeader, {backgroundColor: COLORS.slateBlue}]}>
                        ...
                        {/* --- SPREMEMBA: Dodana barva rgb(148, 163, 184) --- */}
...
const styles = StyleSheet.create({
  ...
  mainHeader: {
      ...
      paddingTop: 20, // SPREMENJENO NA 20
      paddingBottom: 10, // SPREMENJENO NA 10
  },
  ...
  gameCard: { backgroundColor: COLORS.card, borderRadius: 20, padding: 18, borderWidth: 1, borderColor: COLORS.border },
  ...
  emptyText: { color: COLORS.textMuted, fontSize: 18, marginBottom: 8 },
  ...
  playerRowContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.inputBg, borderRadius: 12, marginBottom: 8, paddingVertical: 14, paddingHorizontal: 16, gap: 12 },
  rankContainer: { width: 32, alignItems: 'center' },
  rankNumber: { color: COLORS.textMuted, fontSize: 16, fontWeight: '600' },
  playerName: { flex: 1, color: COLORS.text, fontSize: 16, fontWeight: '500', marginLeft: 8 },
  ...
  gradientButton: { padding: 16, borderRadius: 12, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 8 }, 
  deleteButton: { backgroundColor: COLORS.danger, padding: 16, borderRadius: 12, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: 8 },
  deleteButtonFlex: { flex: 1 },
  deleteButtonText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  buttonText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  
  closeButton: { backgroundColor: '#5863ea', padding: 16, borderRadius: 12, alignItems: 'center', borderWidth: 0 },
  ...
  historyItem: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 12, paddingHorizontal: 16, backgroundColor: COLORS.inputBg, borderRadius: 8, marginBottom: 8 },
  ...
  formCard: { backgroundColor: COLORS.inputBg, width: '100%', padding: 20, borderRadius: 16, alignItems: 'center', borderWidth: 1, borderColor: COLORS.border },
